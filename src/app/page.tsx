      ...
      >
        ...
        <section id="about" className="bg-white p-6 mb-8 rounded-lg shadow-md mt-8">
          ...
          <p className="text-lg text-gray-900">
            ...
            CSSやTypeScript、Node.jsなどの技術も積極的に学習・活用しています。また、GitやGitHubを用いたバージョン管理にも取り組み、実務での経験を活かしながら、常に新しい知識を吸収し柔軟に対応できる力を身につけています。今後はこれまでのWebコーディングの経験を基盤に、よりUIや機能面にも踏み込んだ開発に携わり、フロントエンド領域でも価値を発揮できる人材を目指しています。
          </p>
        </section>
