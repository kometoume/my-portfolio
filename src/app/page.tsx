      ...
      >
        ...
        <section id="about" className="bg-white p-6 mb-8 rounded-lg shadow-md mt-8">
          ...
          <p className="text-lg text-gray-900">
            Web制作に携わる中で、より高い専門性を身につけ、スキルを向上させたいという思いが強まり、今後の成長を見据えて転職を決意いたしました。このポートフォリオサイトも、自身でReactとNext.jsを用いて開発しています。これまでの実務経験を活かしながら、新しい環境にも柔軟に対応し、さらなる成長を目指して前向きに取り組んでまいります。          </p>
        </section>
